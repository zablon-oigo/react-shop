...
function Contact() {
  return (
    <>
    <div className="rounded-[50px] w-full  my-16 lg:h-[36rem] bg-furniture bg-no-repeat bg-cover bg-bottom  sm:p-16 px-10 py-6" data-aos="zoom-in">
       <div className="flex flex-col justify-center w-full h-full -mt-32"
       >
       <div className="">
       <h2 className="font-semibold leading-snug text-white capitalize md:text-5xl"
       data-aos="fade-right"
       data-aos-duration="2000"
       data-aos-easing="ease-in-sine"
       >subscribe and get  <span className="text-secondary">10% OFF</span>   </h2>
        <p className="mt-3 text-sm font-semibold leading-10 text-white capitalize"
        data-aos="fade-right"
